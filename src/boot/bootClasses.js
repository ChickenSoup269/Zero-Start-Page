...
export function applyBootBodyClasses(settings) {
  ...
  if (settings.bookmarkSidebarMode === true && layout === "default") layout = "sidebar"
  ...
  else if (layout === "taskbar-top") body.classList.add("bookmark-taskbar-top-mode")
  else if (layout === "taskbar-left") body.classList.add("bookmark-taskbar-left-mode")
  else if (layout === "taskbar-right") body.classList.add("bookmark-taskbar-right-mode")
  ...
  if (settings.bookmarkGroupAutoTextContrast === true) body.classList.add("bookmark-group-auto-text-contrast")
  ...
  if (settings.bookmarkGroupUseAccent === true) body.classList.add("bookmark-group-accent-enabled")
  if (settings.bookmarkGroupKeepBgOnInteraction !== false) body.classList.add("bookmark-group-keep-bg-on-interaction")
  if ((settings.bookmarkGroupBgOpacity ?? 0) <= 0) body.classList.add("bookmark-group-tab-bg-transparent")
  if (settings.bookmarkGroupContainerBgHidden === true) body.classList.add("bookmark-group-container-bg-hidden")
  if (settings.bookmarkGroupBorderHidden === true) body.classList.add("bookmark-group-border-hidden")
  ...
  if (settings.freeMoveSearchBar === true) body.classList.add("free-move-search-bar")
  if (settings.bookmarkItemStyle === "card") body.classList.add("bookmark-item-card-style")
  ...
  if (bgStyle === "hidden") body.classList.add("bookmark-layout-bg-hidden")
    ...
    root.style.setProperty("--bookmark-layout-bg-color", "rgba(255, 255, 255, 0.85)")
  ...
  if (clockStyleBackground === "transparent") body.classList.add("clock-style-transparent-bg")
  else if (clockStyleBackground === "accent") body.classList.add("clock-style-bg-accent")
  ...
  } else if (clockStyleBackground === "light") body.classList.add("clock-style-bg-light")
  else if (clockStyleBackground === "dark") body.classList.add("clock-style-bg-dark")
  else if (clockStyleBackground === "animated" && dateClockStyle === "prism-stack") {
    body.classList.add("clock-style-bg-animated")
  }

  if (dateClockStyle === "cartoon" && settings.cartoonClockAnimation === false) {
  ...
  if (searchContainer) {
    searchContainer.style.display = settings.showSearchBar !== false ? "" : "none"
  }
  ...
  root.style.setProperty("--search-bar-radius", `${settings.searchBarRadius ?? 20}px`)

  // ── Bookmarks Container visibility ───────────────────────
  const bookmarksContainer = document.getElementById("bookmarks-container")
  if (bookmarksContainer) {
    bookmarksContainer.style.display = settings.showBookmarks !== false ? "" : "none"
  }
  const bookmarkGroupsContainer = document.getElementById("bookmark-groups-container")
  if (bookmarkGroupsContainer) {
    bookmarkGroupsContainer.style.display = settings.showBookmarkGroups !== false ? "" : "none"
  }
}
