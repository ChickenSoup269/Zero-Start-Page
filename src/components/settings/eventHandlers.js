...
import {
  STYLE_PRESETS,
  INTERFACE_STYLE_KEYS,
  setStylePresetActive,
...
import {
  ...
  replaceLocalMediaIds,
  getBackgroundIdentity,
  mergeUserBackgrounds,
  SAVED_GALLERY_KEYS,
  stablePresetIdentity,
  mergePresetArray,
  mergeSavedGallerySettings,
  stripLocalMediaReferences,
  downloadExportPayload,
} from "./dataImportExport.js"
import { initSidebarToC } from "./sidebarToC.js"
...
export { updateMediaSaveButtonsState } from "./mediaUiHelpers.js"
...
export function setupGeneralEventHandlers(
  ...
  initSidebarToC(DOM, sidebarContent)
