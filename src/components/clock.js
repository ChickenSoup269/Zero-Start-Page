...
import { escapeAttribute } from "../utils/strings.js"
...
import { applyHuePerCharacter, applyHueMode } from "./clock/hueRenderer.js"
export { applyHuePerCharacter, applyHueMode }

import {
  formatViShortWeekday,
  getIntlLanguageCode,
  getClockDateLanguageCode,
  isCustomLanguage,
  getCustomTranslation,
  getZonedDateParts,
  getZonedDate,
  getVietnameseLunarParts,
  getZonedWeekdayIndex,
  getLocalizedMonthName,
  getSafeWeekday,
  getCustomDateString,
  _buildSidestyleDateStr,
  getClockLabel,
} from "./clock/clockLocale.js"
export {
  formatViShortWeekday,
  getIntlLanguageCode,
  getClockDateLanguageCode,
...
export function initClock() {
  ...
  const startClockInterval = () => {
    ...
    const settings = getSettings()
    const intervalMs =
      settings.hideSeconds && !isC4BombActive() ? 10000 : 1000
  ...
  initC4BombListeners(clockElement, updateTime)
